...
import { WeddingDivider } from "../SectionDivider";
...
export function About() {
  return (
    <section
      ...
      className="relative w-full flex flex-col items-center bg-[#F3EBE1] pb-20 md:pb-36"
    >
      ...
      <div className="w-full absolute left-0 top-0 -translate-y-[98%] z-10 pointer-events-none">
        <WeddingDivider />
      </div>
